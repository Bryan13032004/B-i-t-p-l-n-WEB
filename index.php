...
<nav>
  ...
  <?php if (isset($_SESSION['customer_id'])): ?>
    <div class="nav-auth">Xin chào, <?php echo htmlspecialchars($_SESSION['customer_name'] ?? 'Khách'); ?> | <a href="logout.php">Đăng xuất</a></div>
  <?php else: ?>
    <div class="nav-auth"><a href="customer_auth.php?tab=login">Đăng nhập</a> | <a href="customer_auth.php?tab=register">Đăng ký</a></div>
  <?php endif; ?>
</nav>
